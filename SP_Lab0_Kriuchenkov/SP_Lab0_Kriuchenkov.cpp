...
int main()
{
	...
	cout << "Data type: Float. Size in bytes             |" << sizeof(float) << "|Min value|" << FLT_MIN << " |Max value|" << FLT_MAX << "|\n";
	cout << "Data type: Double. Size in bytes            |" << sizeof(double) << "|Min value|" << DBL_MIN << "|Max value|" << DBL_MAX << "|\n";
}
